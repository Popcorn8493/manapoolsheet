    ...
    <div class="location-section" id="{html.escape(location_checkbox_id)}_section">
        <div class="location-header">
            <div>
                ...
                <label for="{html.escape(location_checkbox_id)}">Location: {safe_location} ({len(location_items)} items - ${location_total:.2f})</label>
            </div>
        </div>
            ...
            allCards.forEach(card => {{
                ...
                if (orderIdMatch && orderLabelMatch) {{
                    ...
                    if (locationSection) {{
                        ...
                        if (locationLabel) {{
                            const locationMatch = locationLabel.textContent.match(/Location:\\s*([^(]+)/);
                            if (locationMatch) {{
